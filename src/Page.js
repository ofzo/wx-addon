    ...
    if (config.onShareAppMessage)
        config.onShareAppMessage = function onShareAppMessage(res) {
            ...
            $tap("page.onShareAppMessage.before", this, (options) => {
                returns = $call(config, "onShareAppMessage", this, options, (returns) => {
    ...
    OLD_PAGE({
        ...
        onPullDownRefresh() {
            ...
            $tap("page.onPullDownRefresh.before", this, (options) => {
                returns = $call(config, "onPullDownRefresh", this, options, (returns) => {
                    return $tap("page.onPullDownRefresh.after", this, a => a, returns)
                })
            })
            return returns
        },
